  ...
  timeline: [
    {
      ...
      place: 'Taipei, Taiwan',
      points: [
        'Led R&D of the 2D-to-3D pose lifting system behind the first markerless app offering real-time full golf-swing analysis on-device.',
        'Reduced mean per-joint error 8cm → 3cm; +30% reconstruction fidelity under occlusion and fast motion.',
        'Deployed to Apple ARM silicon via CoreML at 240fps with no cloud dependency, used by PGA professionals.',
