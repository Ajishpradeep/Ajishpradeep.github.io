      ...
      <div className="shell relative">
        ...
        <div className="mt-12 grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-10">
          <div className="lg:col-span-7">
            ...
            */}
            <h3
              className="max-w-[18ch] text-balance font-display text-headline font-extrabold uppercase text-amber"
              data-reveal
            >
              {about.open.heading}
            </h3>
            ...
            */}
            <ul className="grid grid-cols-1 gap-3">
              {site.links.map((l) => {
                ...
                return (
                  <li key={l.label}>
                    {/* The three ways to start the conversation the whole page exists to start. */}
                    <a
                      href={l.href}
