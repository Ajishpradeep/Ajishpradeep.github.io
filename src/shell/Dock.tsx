 ...
 *
 * An earlier index-mapped icon array in the lab — a leaf for
 * CarbonPass, a music note for Magic Shuffle — silently reassigned icons the
 * moment an entry moved. `nav` in site.ts is a list somebody will reorder; this is a map,
