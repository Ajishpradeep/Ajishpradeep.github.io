 ...
 * browser (see src/lib/resume/downloadResumePdf.ts); this exists purely so
 * changes to the document can be *looked at* rather than assumed correct — an
 * earlier pass shipped a PDF with overlapping text because nothing ever
 * rendered it.
 *
 * Run via scripts/render-resume.sh, which bundles the TSX with esbuild first.
 */
import { renderToFile } from '@react-pdf/renderer';
import { ResumePDF } from '../src/lib/resume/resumePdf';
